...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parse_cmd_prefix_fct.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: araout <marvin@42.fr>                      +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/09/23 12:04:02 by araout            #+#    #+#             */
/*   Updated: 2019/09/23 12:08:27 by araout           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "shell.h"

static void		cmd_prefix_fct_cmp(t_edit *line_e, t_ast_ptr *ast_head,\
...
void			cmd_prefix_fct(t_edit *line_e)
{
			...
			&& g_shell.errorno != ER_SYNTAX)
	{
		...
		cmd_prefix_fct_cmp(line_e, ast_head, save, lookahead);
	}
