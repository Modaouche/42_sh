...
#define _LIST_FRONT(_)                  ((element_t*)&(_)->head->data)
#define _LIST_LAST(_)                   ((element_t*)&(_)->tail->data)
...
#define _GENERIC_NULL                   (NULL)
#define _ELEMENT_NULL                   (NULL)

#define _ELEMENT_NODE(_)                ((_node_t*)((uint8_t*)(_) - offsetof(_node_t, data)))
#define _ELEMENT_SIZE(_)                ((size_t)(_ELEMENT_NODE(_)->size))
#define _ELEMENT_GET_METADATA(_)        ((size_t)(_ELEMENT_NODE(_)->meta))
#define _ELEMENT_SET_METADATA(_, _val)  (_ELEMENT_NODE(_)->meta = _val)

typedef void*       generic_t;
typedef generic_t*  element_t;
...
typedef void        (*_destruct_t)(element_t);
typedef element_t   (*_duplicat_t)(element_t);
typedef void        (*_iterator_t)(element_t, size_t);
typedef bool        (*_predicat_t)(element_t, size_t);
...
element_t*  at_list(list_t const*, size_t)                          __attribute__((nothrow));
list_t*     insert_list(list_t*, size_t, size_t, ...)               __attribute__((nothrow));
list_t*     _insert_varg_list(list_t*, size_t, size_t, va_list)     __attribute__((nothrow));
